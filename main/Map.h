...
private:
    ...
    static string const MENU_NORMAL[];
    static string const MENU_ROOM[];
    static string const MENU_NPC[];
    static string const MENU_EXIT[];
    static string const MENU_INVENTORY[];
    static string const MONSTERS[][2];
